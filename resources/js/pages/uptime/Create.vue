                    ...
                    <form @submit.prevent="submit">
                        <div class="mb-4">
                            ...
                            <input
                                id="url"
                                type="url"
                                class="border-input bg-background ring-offset-background file:text-foreground placeholder:text-muted-foreground focus-visible:ring-ring flex h-10 w-full rounded-md border px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-700 dark:text-gray-200 dark:file:text-gray-200 dark:placeholder:text-gray-400"
                                v-model="form.url"
                                required
                                autofocus
                                autocomplete="url"
