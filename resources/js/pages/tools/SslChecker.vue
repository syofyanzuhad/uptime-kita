...
<template>
    <PublicLayout :title="pageTitle" :description="pageDescription" :share-url="shareUrl" :share-text="shareText" container-class="max-w-4xl">
        ...
        <div class="mb-6 text-center sm:mb-8">
            <div
                class="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-md"
            >
                <Icon name="lock" class="h-6 w-6" />
            </div>
            <h1 class="mt-3 text-2xl font-black tracking-tight text-gray-900 sm:text-3xl dark:text-white">SSL Certificate Checker</h1>
        ...
        <div v-if="result && result.ok" class="space-y-4">
                ...
                <div class="flex items-center gap-3.5">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                            Issued by <strong class="text-gray-900 dark:text-white">{{ result.issuer }}</strong> • Checked in
                ...
                <div class="flex items-center gap-2">
                    <div class="rounded-2xl border border-gray-200 bg-white p-3 text-center shadow-xs dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <span
                            ...
                            :class="
                                result.days_remaining && result.days_remaining > 14
                    ...
                    <CardContent class="p-4 sm:p-5">
                        ...
                        <dl class="space-y-2 text-xs">
                            <div class="flex justify-between border-b border-gray-100 pb-1.5 dark:border-gray-800">
                                ...
                                <dd class="max-w-[200px] truncate font-medium text-gray-900 dark:text-white">{{ result.issuer }}</dd>
                            </div>
                            <div class="flex justify-between">
            ...
            <Card v-if="result.sans?.length" class="rounded-3xl border border-gray-200/80 bg-white/80 dark:border-gray-800/80 dark:bg-gray-900/80">
                <CardContent class="p-4 sm:p-5">
                    <h3 class="mb-2 text-xs font-bold tracking-wider text-gray-400 uppercase">
            ...
            <div class="rounded-2xl border border-blue-200 bg-blue-50/70 p-4 text-center dark:border-blue-900/40 dark:bg-blue-950/30">
                <p class="text-xs font-bold text-blue-900 dark:text-blue-200">Want automatic alerts before your SSL certificate expires?</p>
