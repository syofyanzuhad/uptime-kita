...
<template>
    ...
    <div class="mb-4 overflow-hidden rounded-2xl sm:rounded-3xl border border-gray-200/80 bg-white shadow-xs dark:border-gray-800/80 dark:bg-gray-900/90">
        <div class="grid grid-cols-3 divide-y sm:divide-y-0 sm:grid-cols-6 sm:divide-x divide-gray-100 dark:divide-gray-800/80">
            <component
                ...
                class="group flex flex-col items-center justify-center py-4 px-3 text-center transition-colors"
                :class="[
                    item.hasBorderRight ? 'border-r border-gray-100 dark:border-gray-800/80 sm:border-r-0' : '',
            ...
            >
                <div class="flex items-center gap-1.5">
                    ...
                    <div v-if="item.loading" class="h-6 w-12 rounded bg-gray-200 dark:bg-gray-800 animate-pulse my-0.5"></div>
                    <span v-else class="text-xl sm:text-2xl font-black tracking-tight" :class="item.valueColor">
                        {{ item.value }}
                    </span>
                </div>
