 ...
 */
const ToggleNotificationChannelController = (
 ...
 * @route '/settings/notifications/{notification}/toggle'
 */
ToggleNotificationChannelController.url = (
    args: { notification: string | number } | [notification: string | number] | string | number,
    options?: RouteQueryOptions,
) => {
    ...
    return (
        ToggleNotificationChannelController.definition.url.replace('{notification}', parsedArgs.notification.toString()).replace(/\/+$/, '') +
        queryParams(options)
    );
};
 ...
 * @route '/settings/notifications/{notification}/toggle'
 */
ToggleNotificationChannelController.patch = (
    args: { notification: string | number } | [notification: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'patch'> => ({
    url: ToggleNotificationChannelController.url(args, options),
