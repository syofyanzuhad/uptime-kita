 ...
 */
const StatusPageDisassociateMonitorController = (
    args:
 ...
 * @route '/status-pages/{statusPage}/monitors/{monitor}'
 */
StatusPageDisassociateMonitorController.url = (
    args:
        | { statusPage: string | number | { id: string | number }; monitor: string | number | { id: string | number } }
        | [statusPage: string | number | { id: string | number }, monitor: string | number | { id: string | number }],
    options?: RouteQueryOptions,
    ...
    return (
        StatusPageDisassociateMonitorController.definition.url
 ...
 * @route '/status-pages/{statusPage}/monitors/{monitor}'
 */
StatusPageDisassociateMonitorController.delete = (
    args:
        | { statusPage: string | number | { id: string | number }; monitor: string | number | { id: string | number } }
        | [statusPage: string | number | { id: string | number }, monitor: string | number | { id: string | number }],
    options?: RouteQueryOptions,
