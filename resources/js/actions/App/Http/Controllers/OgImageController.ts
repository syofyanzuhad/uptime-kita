...
/**
 * @see \App\Http\Controllers\OgImageController::monitorsIndex
 * @see app/Http/Controllers/OgImageController.php:21
 * @route '/og/monitors.png'
 */
export const monitorsIndex = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: monitorsIndex.url(options),
    method: 'get',
});

monitorsIndex.definition = {
    methods: ['get', 'head'],
    url: '/og/monitors.png',
 ...
 * @route '/og/monitors.png'
 */
monitorsIndex.url = (options?: RouteQueryOptions) => {
    return monitorsIndex.definition.url + queryParams(options);
};
 ...
 * @route '/og/monitors.png'
 */
monitorsIndex.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: monitorsIndex.url(options),
    method: 'get',
});
 ...
 * @route '/og/monitors.png'
 */
monitorsIndex.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: monitorsIndex.url(options),
    method: 'head',
});
...
monitor.url = (args: { domain: string | number } | [domain: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return monitor.definition.url.replace('{domain}', parsedArgs.domain.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
statusPage.url = (args: { path: string | number } | [path: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return statusPage.definition.url.replace('{path}', parsedArgs.path.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
const OgImageController = { monitorsIndex, monitor, statusPage };

export default OgImageController;
