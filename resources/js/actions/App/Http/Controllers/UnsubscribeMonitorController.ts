 ...
 */
const UnsubscribeMonitorController = (
 ...
 * @route '/monitor/{monitorId}/unsubscribe'
 */
UnsubscribeMonitorController.url = (
    args: { monitorId: string | number } | [monitorId: string | number] | string | number,
    options?: RouteQueryOptions,
) => {
    ...
    return (
        UnsubscribeMonitorController.definition.url.replace('{monitorId}', parsedArgs.monitorId.toString()).replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/monitor/{monitorId}/unsubscribe'
 */
UnsubscribeMonitorController.delete = (
    args: { monitorId: string | number } | [monitorId: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'delete'> => ({
    url: UnsubscribeMonitorController.url(args, options),
