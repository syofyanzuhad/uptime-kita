...
*/
export const getContext = (args: { trace: string | number } | [trace: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
getContext.url = (args: { trace: string | number } | [trace: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return getContext.definition.url
...
* @route '/api/trace-replay/traces/{trace}/context'
*/
getContext.get = (args: { trace: string | number } | [trace: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getContext.url(args, options),
    method: 'get',
})
...
* @route '/api/trace-replay/traces/{trace}/context'
*/
getContext.head = (args: { trace: string | number } | [trace: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: getContext.url(args, options),
    method: 'head',
})
...
*/
export const triggerReplay = (args: { trace: string | number } | [trace: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
triggerReplay.url = (args: { trace: string | number } | [trace: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return triggerReplay.definition.url
            .replace('{trace}', parsedArgs.trace.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/api/trace-replay/traces/{trace}/replay'
*/
triggerReplay.post = (args: { trace: string | number } | [trace: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: triggerReplay.url(args, options),
    method: 'post',
})
...
*/
export const generateFixPrompt = (args: { trace: string | number } | [trace: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
generateFixPrompt.url = (args: { trace: string | number } | [trace: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return generateFixPrompt.definition.url
            .replace('{trace}', parsedArgs.trace.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/api/trace-replay/traces/{trace}/fix-prompt'
*/
generateFixPrompt.get = (args: { trace: string | number } | [trace: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: generateFixPrompt.url(args, options),
    method: 'get',
})
...
* @route '/api/trace-replay/traces/{trace}/fix-prompt'
*/
generateFixPrompt.head = (args: { trace: string | number } | [trace: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: generateFixPrompt.url(args, options),
    method: 'head',
})
