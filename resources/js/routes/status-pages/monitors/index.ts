...
export const associate = (
    args: { statusPage: number | { id: number } } | [statusPage: number | { id: number }] | number | { id: number },
...
associate.url = (
    ...
    return associate.definition.url.replace('{statusPage}', parsedArgs.statusPage.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
export const disassociate = (
    args:
        | { statusPage: number | { id: number }; monitor: number | { id: number } }
        | [statusPage: number | { id: number }, monitor: number | { id: number }],
    options?: RouteQueryOptions,
...
available.url = (
    ...
    return available.definition.url.replace('{statusPage}', parsedArgs.statusPage.toString()).replace(/\/+$/, '') + queryParams(options);
};
