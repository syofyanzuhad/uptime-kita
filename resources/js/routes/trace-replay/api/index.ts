...
context.url = (args: { trace: string | number } | [trace: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return context.definition.url.replace('{trace}', parsedArgs.trace.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
replay.url = (args: { trace: string | number } | [trace: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return replay.definition.url.replace('{trace}', parsedArgs.trace.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
fixPrompt.url = (args: { trace: string | number } | [trace: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return fixPrompt.definition.url.replace('{trace}', parsedArgs.trace.toString()).replace(/\/+$/, '') + queryParams(options);
};
